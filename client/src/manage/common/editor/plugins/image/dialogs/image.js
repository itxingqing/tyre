        ...
        return {
            ...
            contents: [{
                ...
                elements: [
                    ...
                    {
                        type: 'file',
                        id: 'upload', //这里可以改成f，那么input的name就是f与下面同时改
                        label: d.lang.image.btnUpload,
                        style: 'height:40px',
                        setup: function (widget) {

                            //取消元素上传input框后面的一堆上传文字
                            this.getInputElement().$.style.color = "transparent";
                        },
                        onChange: function (evt) {
                            ...
                            if (ext != 'png' && ext != 'jpg' && ext != 'jpeg') {
                                alert('请上传png、jpg或jpeg格式图片文件');
                            } else {
                                var fileElem = this.getInputElement().$,
                                    file = fileElem.files[0],
                                    url = evt.sender.action,
                                    data = new FormData(),
                                ...
                                xhr.addEventListener("load", function (evt) {
                                    ...
                                    //d是当前editor，全局已经赋值了
                                    if (d.config.imgUploadDataFile) {
                                        var fields = d.config.imgUploadDataFile;
                                    ...
                                    if (upUrl) {
                                        ...
                                        dialog.getContentElement('info', 'txtUrl').setValue(upUrl);
